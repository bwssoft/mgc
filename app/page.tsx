                ...
                >
                  <div>
                    <div className="flex items-center justify-between gap-x-4">
                      ...
                      {tier.mostPopular ? (
                        <p className="rounded-full bg-pink-600/10 px-2.5 py-1 text-xs/5 font-semibold text-pink-600">
                          Most popular
                        </p>
                      ) : null}
                    </div>
                  ...
                  <a
                    ...
                    className={cn(
                      ...
                      "mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600"
                    )}
                  >
                    Buy plan
                  </a>
